...
public class GuilScrolledBox extends GuiElement {
	...
	public void render() {
		...
		// TODO - Fyber - Changed texture bind method
		//Minecraft.getMinecraft().getTextureManager().bindTexture(Gui.optionsBackground);
        Minecraft.getMinecraft().renderEngine.bindTexture(Minecraft.getMinecraft().renderEngine.getTexture("/gui/background.png"));        
