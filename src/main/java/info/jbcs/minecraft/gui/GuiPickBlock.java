...
public class GuiPickBlock extends GuiContainer
{
    ...
    {
        GeneralClient.bind("/gui/creative_inv/list_items.png");        
    ...
    {
        super.initGui();        
        controlList.add(scrollbar = new Scrollbar(200, guiLeft + 175, guiTop + 18, 12, 124, "")
        {
            @Override
        ...
        controlList.add(new GuiButton(100, guiLeft + 44, guiTop + 151, 70, 20, "Select"));
    }
