...
public class GuiChisel extends GuiContainer {
	...
	public void onGuiClosed() {
		super.onGuiClosed();
		inventorySlots.onCraftGuiClosed(player); // TODO - Fyber - Changed from onContainerClosed
	}
...
//		this.drawCenteredString(fontRenderer, isExtended()?"Carve":"Carve blocks",  88, 13, 0x888888);
	...
	protected void drawGuiContainerBackgroundLayer(float f, int mx, int my) {
		...
		String texture=isExtended()?
			"/assets/chisel/textures/chisel-gui-24.png":
			"/assets/chisel/textures/chisel-gui.png";
