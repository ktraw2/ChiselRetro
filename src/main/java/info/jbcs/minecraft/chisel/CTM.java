...
public class CTM {
	...
	public static int getTexture(IBlockAccess world, int x, int y, int z, int side) {
		...
		if (side <= 1) {
			b2[0] = !isConnected(world, x + 1, y, z + 1, side, blockId, blockMetadata);
			b2[1] = !isConnected(world, x - 1, y, z + 1, side, blockId, blockMetadata);
			b2[2] = !isConnected(world, x + 1, y, z - 1, side, blockId, blockMetadata);
			b2[3] = !isConnected(world, x - 1, y, z - 1, side, blockId, blockMetadata);
		} else if (side == 2) {
			b2[0] = !isConnected(world, x - 1, y - 1, z, side, blockId, blockMetadata);
			b2[1] = !isConnected(world, x + 1, y - 1, z, side, blockId, blockMetadata);
			b2[2] = !isConnected(world, x - 1, y + 1, z, side, blockId, blockMetadata);
			b2[3] = !isConnected(world, x + 1, y + 1, z, side, blockId, blockMetadata);
		} else if (side == 3) {
			b2[0] = !isConnected(world, x + 1, y - 1, z, side, blockId, blockMetadata);
			b2[1] = !isConnected(world, x - 1, y - 1, z, side, blockId, blockMetadata);
			b2[2] = !isConnected(world, x + 1, y + 1, z, side, blockId, blockMetadata);
			...
			b2[0] = !isConnected(world, x, y - 1, z + 1, side, blockId, blockMetadata);
			b2[1] = !isConnected(world, x, y - 1, z - 1, side, blockId, blockMetadata);
