...
public class RenderBlocksEldritch extends RenderBlocks 
{
    ...
    void setupSides(Block block, Icon icon,int a,int b,int c,int d,int e, int ta,int tb,int tc,int td){
	...
	public void renderNorthFace(Block block, double x, double y, double z, int icon) {
        setupSides(block, icons[4], 1, 0, 4, 5, 9, 4, 5, 1, 0);
        vert(1); vert(0); vert(9); vert(9);
        vert(0); vert(4); vert(9); vert(9);
	...
	public void renderSouthFace(Block block, double x, double y, double z, int icon){
        setupSides(block, icons[5], 3, 2, 6, 7, 11, 3, 2, 6, 7);
        vert(6); vert(7); vert(11); vert(11);
        vert(7); vert(3); vert(11); vert(11);
        vert(3); vert(2); vert(11); vert(11);
        vert(2); vert(6); vert(11); vert(11);

    }

	@Override // z negative
	public void renderEastFace(Block block, double x, double y, double z, int icon){
        setupSides(block, icons[2], 2, 3, 0, 1, 8, 0, 1, 2, 3);
        vert(0); vert(1); vert(8); vert(8);
        vert(1); vert(2); vert(8); vert(8);
	...
	public void renderWestFace(Block block, double x, double y, double z, int icon){
        setupSides(block, icons[3], 4, 7, 6, 5, 10, 7, 6, 5, 4);
        vert(5); vert(4); vert(10); vert(10);
        vert(6); vert(5); vert(10); vert(10);
	...
	public void renderBottomFace(Block block, double x, double y, double z, int icon){
        setupSides(block, icons[0],0,3,7,4,13,0,3,7,4);
        vert(0); vert(3); vert(13); vert(13);
        vert(3); vert(7); vert(13); vert(13);
	...
	public void renderTopFace(Block block, double x, double y, double z, int icon){
        setupSides(block, icons[1],2,1,5,6,12,2,1,5,6);
