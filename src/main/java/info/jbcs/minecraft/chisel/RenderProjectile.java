...
public class RenderProjectile extends Render
{
    ...
    public RenderProjectile(Item par1)
    {
        this.item = par1;
    }
    ...
    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        Icon icon = ((IItemTexture)item).getIcon();
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, Minecraft.getMinecraft().renderEngine.getTexture(item.getTextureFile()));
        ...
        var10.addVertexWithUV((double)(0.0F - var8), (double)(0.0F - var9), 0.0D, (double)var3, (double)var6);
        var10.addVertexWithUV((double)(var7 - var8), (double)(0.0F - var9), 0.0D, (double)var4, (double)var6);
        var10.addVertexWithUV((double)(var7 - var8), (double)(var7 - var9), 0.0D, (double)var4, (double)var5);
        var10.addVertexWithUV((double)(0.0F - var8), (double)(var7 - var9), 0.0D, (double)var3, (double)var5);
        var10.draw();
